# Web Development Project 1 - Maple Ridge Community Bo

Submitted by: Dana Van Hoeven
...
Challenges:
-Setting all this up was a bit of a pain.
-I only know basic JavaScript and had to use Google Gemini to guide me/get started.
-I have never worked with Git, Node.js, or React until now. 

## License

    Copyright [2026] [Dana Van Hoeven]
